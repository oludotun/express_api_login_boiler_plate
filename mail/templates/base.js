...
module.exports = (bodyContent) => {
    let logo = `
        <p style="font-family: Avenir, Helvetica, sans-serif;
                box-sizing: border-box; color: #bbbfc3; font-size: 19px;
    ...
    if(process.env.APP_URL) {
        logo = `
            <a href="${process.env.APP_URL}" style="font-family: Avenir, Helvetica, sans-serif;
                    box-sizing: border-box; color: #bbbfc3; font-size: 19px;
                    font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                ${appName}
            </a>
    ...
    if(process.env.LOGO_URL && process.env.APP_URL) {
        logo = `
            <a href="${process.env.APP_URL}" style="font-family: Avenir, Helvetica, sans-serif;
                    box-sizing: border-box; color: #bbbfc3; font-size: 19px;
                    font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                <img src="${process.env.LOGO_URL}" alt="${appName}" style="max-height: 60px;">
            </a>
        `;
    }
    return `
                        ...
                        <table class="content" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="header" style="font-family: Avenir, Helvetica, sans-serif;
                                        box-sizing: border-box; padding: 25px 0; text-align: center;">
                                    ${logo}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                    <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                            ...
                                            -premailer-width: 570px;">
                                        <tr>
                                            <td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif;
                                                ...
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;
                                                        ...
                                                        text-align: center;">
                                                    You have received this mandatory email to let you know about important changes to your ${appName} account and services.
                                                </p>
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;
                                                        line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px;
                                                        text-align: center;">
